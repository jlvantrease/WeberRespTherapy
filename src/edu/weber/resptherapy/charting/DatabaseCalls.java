...
//			}
    ...
    public boolean createPatient(String firstName, String lastName, String middleName, String dateOfBirth, String gender, String phoneNumber){
        ...
        Patient patient = new Patient(firstName, lastName,middleName, parsedDate , gender, phoneNumber);
